...
modify by Cheng Zhen on 2023/7/13 15:58
"""
...
ALP_BIN_NORMAL = 2105  # Normal operation with progammable dark phase_4
ALP_BIN_UNINTERRUPTED = 2106  # Operation without dark phase_4
...
class ALP4(object):
    ...
    def __exit__(self, alp_type, alp_value, alp_trace):
        """
        by Cheng Zhen
        """
        if alp_type is not None:
            print("alp_type:", alp_type)
            print("alp_value:", alp_value)
            print("alp_trace:", alp_trace)
        self.Halt()
        self.FreeSeq()
        self.Free()
    ...
    def ProjHalt(self):
        ...
        by Cheng Zhen
        """
        self._checkError(self._ALPLib.AlpProjHalt(self.ALP_ID), 'Cannot stop device.')
